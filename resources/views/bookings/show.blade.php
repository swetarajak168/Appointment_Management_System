...
@section('content')
                               ...
                               <h5 class="mt-2"> {{ $date }}</h5>
                                ...
                                @foreach ($schedulesByDate as $key)
                                    @if ($key->status != 'approved')
                                        {{-- {{ dd($schedulesByDate) }} --}}
                                        <button type="button" class="btn btn-info mr-1 mt-1" data-toggle="modal"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form role="form" method="post"
                                                            action="{{ route('booking.store') }}" id="patientform">
                                                            @csrf
    ...
    <div  class="d-flex align-items-center justify-content-center vh-100">
        ...
        <h1 class="text-center" style="color:rgb(255, 196, 0)"> <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>Sorry,  No Schedule Available At The Moment</h1>
    </div>
    @endif
@endsection
