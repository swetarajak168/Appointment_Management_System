                            ...
                            <div class=" card-info">
                                ...
                                <div id="englishdata">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::text('title[en]', null, ['class' => 'form-control col-sm-8', 'placeholder' => 'title']) !!}
                                        </div>
                                        @error('title[en]')
                                ...
                                <div id="nepalidata" style="display:none;">
                                    ...
                                    <div class="form-group  col-md-6">
                                        ...
                                        {!! Form::text('title[np]', null, ['class' => 'form-control col-sm-8', 'placeholder' => 'title']) !!}
                                    </div>
