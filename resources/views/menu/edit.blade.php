                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::text('Name', $menu->Name, ['class' => 'form-control col-sm-8', 'placeholder' => 'Menu Name']) !!}
                                        </div>
                                        @error('Name')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {!! Form::number('Order', $menu->Order, ['class' => 'form-control col-sm-8', 'placeholder' => 'Menu Name']) !!}
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
                                        {!! Form::label('type', 'Selct  a type ', ['class' => 'col-sm-8 col-form-label']) !!}

                                        {!! Form::select('Type', config('dropdown.menuType'), $menu->Type, [
                                    ...
                                    <div id="pageColumn" style="display:none" class="form-group col-md-6">
                                        ...
                                        {!! Form::select('page_id', $page_helper->pageList(), $menu->page->title['en'], [
                                            'class' => 'form-control  col-sm-8',
                                    ...
                                    <div id="moduleColumn" style="display:none" class="form-group col-md-6">
                                        ...
                                        {!! Form::select('module_id', $module_helper->moduleList(), $menu->module->name, [
                                            'class' => 'form-control col-sm-8',
